...
if __name__ == "__main__":
    ...
    benchmark.benchmark_secret_size_scaling(secret_sizes, n=10, k=5)
    ...
    benchmark.benchmark_share_count_scaling(secret_size=10*1024, k=5, share_counts=[5, 10, 20, 30, 50])
